    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SIKH POLRES Asahan</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No</th><th>ID Pelapor</th><th>Nama Pelapor</th><th>Alamat</th>
                                <th>Jenis Kelamin</th><th>Status WN</th><th>Pekerjaan</th><th>No Telp</th>
                            </tr>
                        </thead>
                        <tbody>
